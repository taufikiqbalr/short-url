...
@section('subhead')
    <title>Image Zoom - Tinker - Tailwind HTML Admin Template</title>
@endsection
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-1" data-target="#image-zoom" class="show-code form-check-input mr-0 ml-3" type="checkbox">
                    </div>
                </div>
                <div id="image-zoom" class="p-5">
                    <div class="preview">
                        <div class="leading-relaxed">
                            ...
                            <div class="w-full h-64 my-5 image-fit">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('dist/images/' . $fakers[0]['images'][0]) }}" data-action="zoom" class="w-full rounded-md">
                            </div>
                            <p class="mb-5">
                            ...
                            <div class="w-3/5 h-64 mr-6 float-left image-fit">
                                <img alt="Midone - HTML Admin Template" src="{{ asset('dist/images/' . $fakers[0]['images'][1]) }}" data-action="zoom" class="w-full rounded-md">
                            </div>
                            <p class="mb-5">
                    ...
                    <div class="source-code hidden">
                        <button data-target="#copy-image-zoom" class="copy-code btn py-1 px-2 btn-outline-secondary">
