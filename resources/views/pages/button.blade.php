...
@section('subhead')
    <title>Button - Tinker - Tailwind HTML Admin Template</title>
@endsection
                    ...
                    <div class="preview">
                        <div class="flex flex-wrap">
                            ...
                            <button class="btn btn-secondary w-32 mr-2 mb-2">
                                <i data-lucide="hard-drive" class="w-4 h-4 mr-2"></i> Hard Drive
                            </button>
                            <button class="btn btn-success w-32 mr-2 mb-2">
                                <i data-lucide="calendar" class="w-4 h-4 mr-2"></i> Calendar
                            </button>
